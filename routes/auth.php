...
Route::middleware('guest')->group(function () {
    ...
    Route::post('inicio', [AuthenticatedSessionController::class, 'store']);
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('confirmar-clave', [ConfirmablePasswordController::class, 'show'])
        ->name('password.confirm');

    Route::post('confirmar-clave', [ConfirmablePasswordController::class, 'store']);
